...
func go_metrics(){
        shell_cmd := "sshpass -p Geovis@2023. ssh -o StrictHostKeychecking=no ubuntu@10.1.104.65 \"/cassandra/apache-cassandra-4.1.0/bin/nodetool -u nodetool -pw Geovis.cas123 status\""
